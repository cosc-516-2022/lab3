...
public class SampleBigtable {
  ...
  public static void main(String[] args) throws Exception {
    ...
    String projectId = "autoed";
    String instanceId = "cosc516";
    /* 
    if (args.length != 2) {
    ...
    */
    SampleBigtable helloWorld = new SampleBigtable(projectId, instanceId, "testtable");
    helloWorld.run();
  }

  public SampleBigtable(String projectId, String instanceId, String tableId) throws IOException {
